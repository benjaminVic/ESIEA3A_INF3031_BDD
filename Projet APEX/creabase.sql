...
CREATE TABLE  "CODE" 
   (	"ID_CODE" NUMBER, 
	"COD_VALUE" VARCHAR2(100) NOT NULL ENABLE, 
...
CREATE TABLE  "PROMOTION" 
   (	"ID_PROMOTION" NUMBER, 
	"PRO_PERCENTAGE" NUMBER(5,5) NOT NULL ENABLE, 
...
CREATE TABLE  "UTILISATEUR" 
   (	"ID_UTILISATEUR" NUMBER, 
	...
	"FK_ID_RIGHT_ACCESS" NUMBER NOT NULL DISABLE,
...
CREATE TABLE  "TRANSACT" 
   (	"ID_TRANSACT" NUMBER, 
	"TRN_AMOUNT" NUMBER NOT NULL DISABLE, 
	"TRN_TAX_VALUE" NUMBER(5,5) NOT NULL DISABLE, 
	"TRN_TOTAL" NUMBER(5,2) NOT NULL DISABLE, 
	"TRN_DATE" TIMESTAMP(6) NOT NULL DISABLE, 
...
CREATE TABLE  "AUC_CODE" 
  ...
  "FK_ID_TRANSACT" NUMBER NOT NULL DISABLE, 
