...
prompt  APPLICATION 101 - CDKEYMARKET_BACKOFFICE
--
-- Application Export:
--   Application:     101
--   Name:            CDKEYMARKET_BACKOFFICE
--   Date and Time:   22:33 Tuesday June 13, 2017
--   Exported By:     ADMIN
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4776124661507212));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'CDKEYMARKET'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'CDKEYMARKET_BACKOFFICE'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F101'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 4998409269215442 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 4998607013215442 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5001125595215443 + wwv_flow_api.g_id_offset,
  p_error_template=> 4998002000215441 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20170613223315',
  ...
  p_cust_authentication_process=> '.'||to_char(5005927813215449 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 3,
  p_default_label_template => 5004625020215446 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5003932230215445 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5003012837215444 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5004916605215446 + wwv_flow_api.g_id_offset,
  p_default_button_template => 4999130095215442 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5000124122215443 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5000222840215443 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5001730235215443 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5001125595215443 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5001125595215443 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 4999728757215443 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5000002778215443 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5000706560215443 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss=> '20170613223315',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5006212568215449 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 5021317348215770 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/navigation/tabs/standard/t_jeux_les_moins_chers
wwv_flow_api.create_tab (
  p_id=> 5008732685215471 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_JEUX_LES_MOINS_CHERS',
  p_tab_text => 'Jeux les moins chers',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '2,3,4,5,6',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_promotion
wwv_flow_api.create_tab (
  p_id=> 5015307778215510 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'T_PROMOTION',
  p_tab_text => 'Promotion',
  p_tab_step => 7,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_game
wwv_flow_api.create_tab (
  p_id=> 5017828610215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> 'T_GAME',
...
--application/shared_components/navigation/tabs/standard/t_platform
wwv_flow_api.create_tab (
  p_id=> 5019827951215522 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 40,
  p_tab_name=> 'T_PLATFORM',
  p_tab_text => 'Platform',
  p_tab_step => 9,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
...
wwv_flow_api.create_list_of_values (
  p_id       => 5007420154215468 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(5007420154215468 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5007519254215470 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5007604124215470 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5007718965215470 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5007816505215470 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5007905421215470 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5008014999215471 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5008107045215471 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5008204410215471 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5008331981215471 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5008429563215471 + wwv_flow_api.g_id_offset,
  p_lov_id=>5007420154215468 + wwv_flow_api.g_id_offset,
...
prompt  ...PAGE 1: Jeux les moins chers
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 1
 ,p_tab_set => 'TS1'
 ,p_name => 'Jeux les moins chers'
 ,p_step_title => 'Jeux les moins chers'
 ,p_step_sub_title => 'Jeux les moins chers'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20170613220055'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT gam.GAM_LABEL as "Jeux", tmp.AUC_PRICE as "Prix", pla.PLA_LABEL as "Plateformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT MIN(AUC_PRICE), gam2.ID_GAME, auc2.AUC_PRICE'||chr(10)||
'    FROM auction auc2'||chr(10)||
'    JOIN game gam2 on auc2.FK_ID_GAME = gam2.ID_GAME'||chr(10)||
'    JOIN AUC_CODE aco2 on aco2.FK_ID_AUCTION = auc2.ID_AUCTION'||chr(10)||
'    WHERE aco2.ACO_SOLD = 0 '||chr(10)||
'    group ';

s:=s||'by gam2.ID_GAME, auc2.AUC_PRICE'||chr(10)||
') tmp on tmp.ID_GAME = gam.ID_GAME'||chr(10)||
'order by gam.GAM_LABEL';

wwv_flow_api.create_page_plug (
  p_id=> 5008817171215471 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Jeux les moins chers',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
...
begin
a1:=a1||'SELECT gam.GAM_LABEL as "Jeux", tmp.AUC_PRICE as "Prix", pla.PLA_LABEL as "Plateformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT MIN(AUC_PRICE), gam2.ID_GAME, auc2.AUC_PRICE'||chr(10)||
...
a1:=a1||'by gam2.ID_GAME, auc2.AUC_PRICE'||chr(10)||
') tmp on tmp.ID_GAME = gam.ID_GAME'||chr(10)||
'order by gam.GAM_LABEL';

wwv_flow_api.create_worksheet(
  p_id=> 5008916762215471+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_region_id=> 5008817171215471+wwv_flow_api.g_id_offset,
  p_name=> 'Jeux les moins chers',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 5009009266215479+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5008916762215471+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Jeux',
  p_display_order          =>1,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5009127680215479+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5008916762215471+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Prix',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5009202124215479+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5008916762215471+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Plateformes',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Plateformes',
  p_report_label           =>'Plateformes',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'Jeux:Prix:Plateformes';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5021517694215907+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_worksheet_id => 5008916762215471+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5009914254215486 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Navigation',
  p_region_name=>'',
  p_plug_template=> 5001125595215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 2,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
  p_plug_source_type=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 5003117640215444+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5010111387215487 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 4999728757215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(5007318674215465 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 5004916605215446+ wwv_flow_api.g_id_offset,
...
prompt  ...PAGE 2: Statistiques de vente par jeux
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 2
 ,p_tab_set => 'TS1'
 ,p_name => 'Statistiques de vente par jeux'
 ,p_step_title => 'Statistiques de vente par jeux'
 ,p_step_sub_title => 'Statistiques de vente par jeux'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT gam.GAM_LABEL as "Jeux", tmp.NB_NONVENDU as "Nombre de jeux invendus", tmp.NB_VENDU as "Nombre de jeux vendus", pla.PLA_LABEL as "Platformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT SUM(case when aco2.ACO_SOLD = 0 then 1 else 0 END) as NB_NONVENDU, '||chr(10)||
'           SUM(case when aco2.ACO_SOLD = 1 then 1 else 0 END) as NB_VENDU, '||chr(10)||
'           gam2.I';
...
'    JOIN game gam2 on auc2.FK_ID_GAME = gam2.ID_GAME'||chr(10)||
'    JOIN AUC_CODE aco2 on aco2.FK_ID_AUCTION = auc2.ID_AUCTION'||chr(10)||
'    group by gam2.ID_GAME'||chr(10)||
') tmp on tmp.ID_GAME = gam.ID_GAME'||chr(10)||
'order by gam.GAM_LABEL';

wwv_flow_api.create_page_plug (
  p_id=> 5010426034215487 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Statistiques de vente par jeux',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT gam.GAM_LABEL as "Jeux", tmp.NB_NONVENDU as "Nombre de jeux invendus", tmp.NB_VENDU as "Nombre de jeux vendus", pla.PLA_LABEL as "Platformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT SUM(case when aco2.ACO_SOLD = 0 then 1 else 0 END) as NB_NONVENDU, '||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5010508355215487+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 5010426034215487+wwv_flow_api.g_id_offset,
  p_name=> 'Statistiques de vente par jeux',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5010631230215488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5010508355215487+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Jeux',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5010708669215488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5010508355215487+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nombre de jeux invendus',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Nombre De Jeux Invendus',
  p_report_label           =>'Nombre De Jeux Invendus',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5010820889215488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5010508355215487+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nombre de jeux vendus',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Nombre De Jeux Vendus',
  p_report_label           =>'Nombre De Jeux Vendus',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5010918304215488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5010508355215487+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Platformes',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Platformes',
  p_report_label           =>'Platformes',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'Jeux:Nombre de jeux invendus:Nombre de jeux vendus:Platformes';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5022319772216447+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5010508355215487+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5011111175215488 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
prompt  ...PAGE 3: Statistiques de vente par vendeur
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 3
 ,p_tab_set => 'TS1'
 ,p_name => 'Statistiques de vente par vendeur'
 ,p_step_title => 'Statistiques de vente par vendeur'
 ,p_step_sub_title => 'Statistiques de vente par vendeur'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT gam.GAM_LABEL as "Jeux", tmp.NB_NONVENDU as "Nombre de jeux invendus", tmp.NB_VENDU as "Nombre de jeux vendus", pla.PLA_LABEL as "Platformes", tmp.USR_LAST_NAME as "Vendeur - Nom"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT SUM(case when aco2.ACO_SOLD = 0 then 1 else 0 END) as NB_NONVENDU, '||chr(10)||
'           SUM(case when aco2.ACO_SOLD = 1 then 1 else ';

s:=s||'0 END) as NB_VENDU, '||chr(10)||
'           gam2.ID_GAME,'||chr(10)||
'           seller2.USR_LAST_NAME'||chr(10)||
'    FROM auction auc2'||chr(10)||
'    JOIN game gam2 on auc2.FK_ID_GAME = gam2.ID_GAME'||chr(10)||
'    JOIN AUC_CODE aco2 on aco2.FK_ID_AUCTION = auc2.ID_AUCTION'||chr(10)||
'    JOIN UTILISATEUR seller2 on seller2.ID_UTILISATEUR = auc2.FK_ID_SELLER'||chr(10)||
'    group by gam2.ID_GAME,seller2.USR_LAST_NAME'||chr(10)||
') tmp on tmp.ID_GAME = gam.ID_GAME'||chr(10)||
'order by tmp.NB_VENDU';

wwv_flow_api.create_page_plug (
  p_id=> 5011411614215488 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Statistiques de vente par vendeur',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT gam.GAM_LABEL as "Jeux", tmp.NB_NONVENDU as "Nombre de jeux invendus", tmp.NB_VENDU as "Nombre de jeux vendus", pla.PLA_LABEL as "Platformes", tmp.USR_LAST_NAME as "Vendeur - Nom"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT SUM(case when aco2.ACO_SOLD = 0 then 1 else 0 END) as NB_NONVENDU, '||chr(10)||
...
a1:=a1||'0 END) as NB_VENDU, '||chr(10)||
'           gam2.ID_GAME,'||chr(10)||
'           seller2.USR_LAST_NAME'||chr(10)||
'    FROM auction auc2'||chr(10)||
'    JOIN game gam2 on auc2.FK_ID_GAME = gam2.ID_GAME'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5011518904215488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_region_id=> 5011411614215488+wwv_flow_api.g_id_offset,
  p_name=> 'Statistiques de vente par vendeur',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5011628803215489+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Jeux',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5011716785215489+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nombre de jeux invendus',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5011819858215489+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nombre de jeux vendus',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5011921606215489+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Platformes',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5012009929215489+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Vendeur - Nom',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Vendeur - Nom',
  p_report_label           =>'Vendeur - Nom',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'Jeux:Nombre de jeux invendus:Nombre de jeux vendus:Platformes:Vendeur - Nom';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5022721158216857+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 5011518904215488+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5012226958215489 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
prompt  ...PAGE 4: Remboursement Par Vendeurs Et Par Jeux
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 4
 ,p_tab_set => 'TS1'
 ,p_name => 'Remboursement Par Vendeurs Et Par Jeux'
 ,p_step_title => 'Remboursement Par Vendeurs Et Par Jeux'
 ,p_step_sub_title => 'Remboursement Par Vendeurs Et Par Jeux'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT tmp.USR_LAST_NAME as "Vendeur - nom", tmp.NOMBRE_REMBOURSEMENT as "Nombre de remboursement", gam.GAM_LABEL as "Jeux", pla.PLA_LABEL as "Plateformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT count(tra2.TRN_REFUND_DATE) as NOMBRE_REMBOURSEMENT, gam2.ID_GAME, seller2.USR_LAST_NAME'||chr(10)||
'    FROM auction auc2'||chr(10)||
'    JOIN game gam2 on auc2.FK_ID_GAME = gam';

s:=s||'2.ID_GAME'||chr(10)||
'    JOIN AUC_CODE aco2 on aco2.FK_ID_AUCTION = auc2.ID_AUCTION'||chr(10)||
'    JOIN TRANSACT tra2 on aco2.FK_ID_TRANSACT = tra2.ID_TRANSACT'||chr(10)||
'    JOIN UTILISATEUR seller2 on seller2.ID_UTILISATEUR = auc2.FK_ID_SELLER'||chr(10)||
'    WHERE aco2.ACO_SOLD = 1'||chr(10)||
'    AND tra2.TRN_REFUND_DATE is not null'||chr(10)||
'    group by gam2.ID_GAME, seller2.USR_LAST_NAME'||chr(10)||
') tmp on tmp.ID_GAME = gam.ID_GAME'||chr(10)||
'order by tmp.NOMBRE_REMBOURSEMENT';

wwv_flow_api.create_page_plug (
  p_id=> 5012516241215489 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'REMBOURSEMENT PAR VENDEURS ET PAR JEUX',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT tmp.USR_LAST_NAME as "Vendeur - nom", tmp.NOMBRE_REMBOURSEMENT as "Nombre de remboursement", gam.GAM_LABEL as "Jeux", pla.PLA_LABEL as "Plateformes"'||chr(10)||
'FROM GAME gam'||chr(10)||
'JOIN PLATFORM pla ON gam.FK_ID_PLATFORM = pla.ID_PLATFORM'||chr(10)||
'JOIN ('||chr(10)||
'    SELECT count(tra2.TRN_REFUND_DATE) as NOMBRE_REMBOURSEMENT, gam2.ID_GAME, seller2.USR_LAST_NAME'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5012609194215491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 5012516241215489+wwv_flow_api.g_id_offset,
  p_name=> 'REMBOURSEMENT PAR VENDEURS ET PAR JEUX',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5012721762215491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5012609194215491+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Vendeur - nom',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5012808173215491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5012609194215491+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nombre de remboursement',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Nombre De Remboursement',
  p_report_label           =>'Nombre De Remboursement',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5012913653215491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5012609194215491+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Jeux',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5013018213215491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5012609194215491+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Plateformes',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'Vendeur - nom:Nombre de remboursement:Jeux:Plateformes';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5021918733216174+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5012609194215491+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5013218935215491 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
prompt  ...PAGE 5: Statistiques clients
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 5
 ,p_tab_set => 'TS1'
 ,p_name => 'Statistiques clients'
 ,p_step_title => 'Statistiques clients'
 ,p_step_sub_title => 'Statistiques clients'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT USR.USR_LAST_NAME as "Acheteur - nom", sum(TRN.TRN_TOTAL) as "Depense totale", avg(TRN.TRN_TOTAL) as "Depense moyenne", USR.USR_MAIL as "Acheteur - mail"'||chr(10)||
'FROM UTILISATEUR USR'||chr(10)||
'JOIN TRANSACT TRN on TRN.FK_ID_BUYER = USR.ID_UTILISATEUR'||chr(10)||
'WHERE TRN_REFUND_DATE is null'||chr(10)||
'AND TRN_DATE is not null'||chr(10)||
'GROUP BY USR.USR_LAST_NAME, USR.USR_MAIL';

wwv_flow_api.create_page_plug (
  p_id=> 5013528014215492 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Statistiques clients',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT USR.USR_LAST_NAME as "Acheteur - nom", sum(TRN.TRN_TOTAL) as "Depense totale", avg(TRN.TRN_TOTAL) as "Depense moyenne", USR.USR_MAIL as "Acheteur - mail"'||chr(10)||
'FROM UTILISATEUR USR'||chr(10)||
'JOIN TRANSACT TRN on TRN.FK_ID_BUYER = USR.ID_UTILISATEUR'||chr(10)||
'WHERE TRN_REFUND_DATE is null'||chr(10)||
'AND TRN_DATE is not null'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5013602303215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_region_id=> 5013528014215492+wwv_flow_api.g_id_offset,
  p_name=> 'Statistiques clients',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5013705220215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5013602303215492+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Acheteur - nom',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Acheteur - Nom',
  p_report_label           =>'Acheteur - Nom',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5013808336215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5013602303215492+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Depense totale',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Depense Totale',
  p_report_label           =>'Depense Totale',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5013921761215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5013602303215492+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Depense moyenne',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Depense Moyenne',
  p_report_label           =>'Depense Moyenne',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5014009638215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_worksheet_id => 5013602303215492+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Acheteur - mail',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Acheteur - Mail',
  p_report_label           =>'Acheteur - Mail',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5014207890215492 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 6
 ,p_tab_set => 'TS1'
 ,p_name => 'Taxes par etats'
 ,p_step_title => 'Taxes par etats'
 ,p_step_sub_title => 'Taxes par etats'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
declare
  ...
  l_length number := 1;
begin
s:=s||'SELECT COU.COU_LABEL as "Pays", SUM(TRN.TRN_TAX_VALUE) as "Taxes dûes"'||chr(10)||
'FROM COUNTRY COU'||chr(10)||
'JOIN TRANSACT TRN on TRN.FK_ID_COUNTRY = COU.ID_COUNTRY'||chr(10)||
'WHERE TRN.TRN_REFUND_DATE is null'||chr(10)||
'GROUP BY COU.COU_LABEL';

wwv_flow_api.create_page_plug (
  p_id=> 5014532488215492 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Taxes par etats',
  p_region_name=>'',
  p_plug_template=> 5000706560215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'SELECT COU.COU_LABEL as "Pays", SUM(TRN.TRN_TAX_VALUE) as "Taxes dûes"'||chr(10)||
'FROM COUNTRY COU'||chr(10)||
'JOIN TRANSACT TRN on TRN.FK_ID_COUNTRY = COU.ID_COUNTRY'||chr(10)||
'WHERE TRN.TRN_REFUND_DATE is null'||chr(10)||
'GROUP BY COU.COU_LABEL';
...
wwv_flow_api.create_worksheet(
  p_id=> 5014621262215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_region_id=> 5014532488215492+wwv_flow_api.g_id_offset,
  p_name=> 'Taxes par etats',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5014718964215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5014621262215492+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5014811880215492+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5014621262215492+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Taxes dûes',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Taxes Dûes',
  p_report_label           =>'Taxes Dûes',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'Pays:Taxes dûes';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5023123582217593+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5014621262215492+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5015027457215492 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20170613222401'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5015421363215510 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'PROMOTION',
  p_region_name=>'',
  p_plug_template=> 5000222840215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5017500208215518 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5015518076215510 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 10,
  p_button_plug_id => 5015421363215510+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(4999130095215442+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 5015709846215510 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  ...
  p_button_condition=> 'P7_ID_PROMOTION',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5015803513215510 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
...
wwv_flow_api.create_page_button(
  p_id             => 5015613203215510 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
...
wwv_flow_api.create_page_branch(
  p_id=>5016000752215513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
wwv_flow_api.create_page_item(
  p_id=>5016105719215514 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_ID_PROMOTION',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5015421363215510+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Id Promotion',
  p_source=>'ID_PROMOTION',
  ...
  p_field_template=> 5004625020215446+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
wwv_flow_api.create_page_item(
  p_id=>5016204456215514 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PRO_PERCENTAGE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  ...
  p_prompt=>'Taux de la promotion',
  p_source=>'PRO_PERCENTAGE',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5016413487215516 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PRO_CODE',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5016603483215516 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PRO_START_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Date de début de la promotion (incluse)',
  p_source=>'PRO_START_DATE',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5016922990215516 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_PRO_END_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Date de fin (exclue)',
  p_source=>'PRO_END_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
wwv_flow_api.create_page_validation(
  p_id => 5016826533215516 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P7_PRO_START_DATE must be timestamp',
  p_validation_sequence=> 3,
  p_validation => 'P7_PRO_START_DATE',
  p_validation_type => 'ITEM_IS_TIMESTAMP',
  p_error_message => '#LABEL# must be a valid timestamp.',
  p_associated_item=> 5016603483215516 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 5017105496215516 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P7_PRO_END_DATE must be timestamp',
  p_validation_sequence=> 4,
  p_validation => 'P7_PRO_END_DATE',
  p_validation_type => 'ITEM_IS_TIMESTAMP',
  p_error_message => '#LABEL# must be a valid timestamp.',
  p_associated_item=> 5016922990215516 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PROMOTION:P7_ID_PROMOTION:ID_PROMOTION';

wwv_flow_api.create_page_process(
  p_id     => 5017230970215517 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from PROMOTION',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PROMOTION:P7_ID_PROMOTION:ID_PROMOTION|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5017314993215518 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of PROMOTION',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table PROMOTION.',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5017914202215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'GAME',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5019521384215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5018030435215520 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 10,
  p_button_plug_id => 5017914202215520+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(4999130095215442+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 5018232010215520 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 30,
  p_button_plug_id => 5017914202215520+wwv_flow_api.g_id_offset,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P8_ID_GAME',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5018314321215520 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 40,
  p_button_plug_id => 5017914202215520+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5018111686215520 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 20,
  p_button_plug_id => 5017914202215520+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5018426019215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5018503577215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_ID_GAME',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5017914202215520+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Id Game',
  p_source=>'ID_GAME',
  p_source_type=> 'DB_COLUMN',
...
wwv_flow_api.create_page_item(
  p_id=>5018613595215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_GAM_LABEL',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5018802960215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_GAM_DESCRIPTION',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 2,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Description du jeu',
  p_source=>'GAM_DESCRIPTION',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5019001984215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_FK_ID_PLATFORM',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
  ...
  p_lov=> 'select PLA_LABEL as display_value, ID_PLATFORM as return_value '||chr(10)||
'  from PLATFORM'||chr(10)||
' order by 1',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:GAME:P8_ID_GAME:ID_GAME';

wwv_flow_api.create_page_process(
  p_id     => 5019217173215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:GAME:P8_ID_GAME:ID_GAME|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5019321459215520 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20170613221228'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5019912155215522 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'PLATFORM',
  p_region_name=>'',
  p_plug_template=> 5000222840215443+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5021112258215525 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5020026588215522 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 5019912155215522+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_image   => 'template:'||to_char(4999130095215442+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Cancel',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_button(
  p_id             => 5020221885215522 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  p_button_plug_id => 5019912155215522+wwv_flow_api.g_id_offset,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P9_ID_PLATFORM',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5020330748215522 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 40,
  p_button_plug_id => 5019912155215522+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5020110872215522 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 20,
  p_button_plug_id => 5019912155215522+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5020427725215522 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5020506247215523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_ID_PLATFORM',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5019912155215522+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Id Platform',
  p_source=>'ID_PLATFORM',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
wwv_flow_api.create_page_item(
  p_id=>5020605662215523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_PLA_LABEL',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PLATFORM:P9_ID_PLATFORM:ID_PLATFORM';

wwv_flow_api.create_page_process(
  p_id     => 5020813742215523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from PLATFORM',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PLATFORM:P9_ID_PLATFORM:ID_PLATFORM|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5020917670215523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of PLATFORM',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table PLATFORM.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 4997602446215441 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5006527234215461 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5006600127215462 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5006527234215461+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5006712796215462 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5006817017215463 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(4999130095215442 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 5007007304215464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5006929302215464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5007202948215465 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5007103173215464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 5003012837215444 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 5009429021215480 + wwv_flow_api.g_id_offset,
  p_list_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
  p_list_item_link_text=> 'Statistiques clients',
  p_list_item_link_target=> 'f?p=&FLOW_ID.:5:&SESSION.::&DEBUG.:',
...
wwv_flow_api.create_list_item (
  p_id=> 5009515780215486 + wwv_flow_api.g_id_offset,
  p_list_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>20,
  p_list_item_link_text=> 'Remboursement Par Vendeurs Et Par Jeux',
...
wwv_flow_api.create_list_item (
  p_id=> 5009616597215486 + wwv_flow_api.g_id_offset,
  p_list_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>30,
  p_list_item_link_text=> 'Statistiques de vente par jeux',
...
wwv_flow_api.create_list_item (
  p_id=> 5009710295215486 + wwv_flow_api.g_id_offset,
  p_list_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>40,
  p_list_item_link_text=> 'Statistiques de vente par vendeur',
...
wwv_flow_api.create_list_item (
  p_id=> 5009800682215486 + wwv_flow_api.g_id_offset,
  p_list_id=> 5009315106215480 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>50,
  p_list_item_link_text=> 'Taxes par etats',
...
wwv_flow_api.create_menu (
  p_id=> 5007318674215465 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Jeux les moins chers',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5011022147215488 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_option_sequence=>20,
  p_short_name=>'Statistiques de vente par jeux',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5012127840215489 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_option_sequence=>30,
  p_short_name=>'Statistiques de vente par vendeur',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5013126950215491 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_option_sequence=>40,
  p_short_name=>'Remboursement Par Vendeurs Et Par Jeux',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5014126359215492 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_option_sequence=>50,
  p_short_name=>'Statistiques clients',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5014920471215492 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>5010007799215486 + wwv_flow_api.g_id_offset,
  p_option_sequence=>60,
  p_short_name=>'Taxes par etats',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5017410333215518 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>5019430955215520 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>5021017649215525 + wwv_flow_api.g_id_offset,
  p_menu_id=>5007318674215465 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>90,
  p_short_name=>'Platform',
  p_long_name=>'',
...
prompt  ......Page template 4997602446215441
...
wwv_flow_api.create_template(
  p_id=> 4997602446215441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 4997703668215441
...
wwv_flow_api.create_template(
  p_id=> 4997703668215441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4997802066215441
...
wwv_flow_api.create_template(
  p_id=> 4997802066215441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4997926040215441
...
wwv_flow_api.create_template(
  p_id=> 4997926040215441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998002000215441
...
wwv_flow_api.create_template(
  p_id=> 4998002000215441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998125896215442
...
wwv_flow_api.create_template(
  p_id=> 4998125896215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998216968215442
...
wwv_flow_api.create_template(
  p_id=> 4998216968215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998319977215442
...
wwv_flow_api.create_template(
  p_id=> 4998319977215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998409269215442
...
wwv_flow_api.create_template(
  p_id=> 4998409269215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998500168215442
...
wwv_flow_api.create_template(
  p_id=> 4998500168215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 4998607013215442
...
wwv_flow_api.create_template(
  p_id=> 4998607013215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998725516215442
...
wwv_flow_api.create_template(
  p_id=> 4998725516215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998811363215442
...
wwv_flow_api.create_template(
  p_id=> 4998811363215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4998907931215442
...
wwv_flow_api.create_template(
  p_id=> 4998907931215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 4999015491215442
...
wwv_flow_api.create_template(
  p_id=> 4999015491215442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 4999130095215442
declare
...
wwv_flow_api.create_button_templates (
  p_id=>4999130095215442 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 4999216425215442
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>4999216425215442 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 4999330180215442
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>4999330180215442 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 4999426218215442
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>4999426218215442 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 4999500769215442
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4999500769215442 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 4999614934215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4999614934215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 4999728757215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4999728757215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 4999822410215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4999822410215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 4999908410215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 4999908410215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5000002778215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000002778215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000124122215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000124122215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000222840215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000222840215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5000332490215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000332490215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000415904215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000415904215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000500639215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000500639215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000620525215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000620525215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5000706560215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000706560215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5000811691215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000811691215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5000911107215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5000911107215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5001027708215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001027708215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5001125595215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001125595215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5001205615215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001205615215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5001316641215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001316641215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5001421331215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001421331215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5001530134215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001530134215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="sidebar-region">'||chr(10)||
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5001603442215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001603442215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5001730235215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001730235215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5001825526215443
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5001825526215443 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-wizard">'||chr(10)||
...
prompt  ......list template 5001902479215443
...
wwv_flow_api.create_list_template (
  p_id=>5001902479215443 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5002006435215444
...
wwv_flow_api.create_list_template (
  p_id=>5002006435215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002101834215444
...
wwv_flow_api.create_list_template (
  p_id=>5002101834215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002226999215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002226999215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002322681215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002322681215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002423035215444
...
wwv_flow_api.create_list_template (
  p_id=>5002423035215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002513220215444
...
wwv_flow_api.create_list_template (
  p_id=>5002513220215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002625400215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002625400215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002707139215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002707139215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002804050215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002804050215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5002923949215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5002923949215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5003012837215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5003012837215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5003117640215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5003117640215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5003228035215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5003228035215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5003331553215444
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5003331553215444 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5003420780215444
...
wwv_flow_api.create_row_template (
  p_id=> 5003420780215444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5003513400215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5003513400215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5003631300215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5003631300215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5003718304215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5003718304215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5003828543215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5003828543215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5003932230215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5003932230215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5004031807215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5004031807215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5004123482215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5004123482215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5004202636215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5004202636215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5004301075215445
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5004301075215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5004410358215445
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5004410358215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5004508349215445
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5004508349215445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5004625020215446
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5004625020215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5004730970215446
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5004730970215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5004805077215446
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5004805077215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5004916605215446
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5004916605215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5005025898215446
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5005025898215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5005726873215447
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5005726873215447 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5005103453215446
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5005103453215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5005302627215446
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5005302627215446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5005524368215447
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5005524368215447 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5005801448215447
begin
wwv_flow_api.create_theme (
  p_id =>5005801448215447 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 3,
  ...
  p_login_template=>4997602446215441 + wwv_flow_api.g_id_offset,
  p_default_button_template=>4999130095215442 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5001125595215443 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5000124122215443 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5000222840215443 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5004625020215446 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5004916605215446 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5005103453215446 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5003012837215444 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5004625020215446 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5004805077215446 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 5015915404215511 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5005927813215449
...
wwv_flow_api.create_auth_setup (
  p_id=> 5005927813215449 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5006023441215449
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5006023441215449 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5006126900215449
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5006126900215449 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
